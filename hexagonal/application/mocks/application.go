...
import (
	application "myrnova/hexagonal/application"
	reflect "reflect"
...
// MockProductPersistentInterface is a mock of ProductPersistentInterface interface.
type MockProductPersistentInterface struct {
	ctrl     *gomock.Controller
	recorder *MockProductPersistentInterfaceMockRecorder
}

// MockProductPersistentInterfaceMockRecorder is the mock recorder for MockProductPersistentInterface.
type MockProductPersistentInterfaceMockRecorder struct {
	mock *MockProductPersistentInterface
}

// NewMockProductPersistentInterface creates a new mock instance.
func NewMockProductPersistentInterface(ctrl *gomock.Controller) *MockProductPersistentInterface {
	mock := &MockProductPersistentInterface{ctrl: ctrl}
	mock.recorder = &MockProductPersistentInterfaceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockProductPersistentInterface) EXPECT() *MockProductPersistentInterfaceMockRecorder {
	return m.recorder
}

// Get mocks base method.
func (m *MockProductPersistentInterface) Get(id string) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Get indicates an expected call of Get.
func (mr *MockProductPersistentInterfaceMockRecorder) Get(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockProductPersistentInterface)(nil).Get), id)
}

// Save mocks base method.
func (m *MockProductPersistentInterface) Save(product application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", product)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Save indicates an expected call of Save.
func (mr *MockProductPersistentInterfaceMockRecorder) Save(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockProductPersistentInterface)(nil).Save), product)
}
